...
for device in a.devices:
    ...
    if device.type == "mouse":
        ...
        device.fx.misc.backlight.breath_dual(75, 156, 211, 122, 174, 211)
        device.fx.misc.scroll_wheel.breath_dual(75, 156, 211, 122, 174, 211)
        device.fx.misc.scroll_wheel.brightness = 75
        device.fx.misc.logo.breath_dual(75, 156, 211, 122, 174, 211)
